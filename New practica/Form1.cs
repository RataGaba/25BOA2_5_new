/*
 * Form1.cs — Версия 1: Только Frontend
 * Работает только кнопка "Очистить".
 * Все остальные кнопки есть но ничего не делают.
 */
...
public partial class Form1 : Form
{
    ...
    {
        Text = "Сортировка Шелла — Shell Sort";
        ...
        lblTitle.Text = "Сортировка Шелла (Shell Sort)";
